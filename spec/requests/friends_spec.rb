...
RSpec.describe "Friends", type: :request do
  let(:realDonaldTrump) { 25073877 }
  let(:katiesvt) { 297789562 }
  let(:jimSterling) { 17214479 }
  ...
  describe "GET /user/:user_id/friends" do
    ...
    context "with restrict_by_user_id param" do
      ...
      it "returns error with invalid user B id" do
        # TODO change to proper error
        get_friend_intersect("im_a_bad_wittle_id", parse: false)
